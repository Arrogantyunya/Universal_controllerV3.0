...
#define A_C003_Channel_1_SlaverTypeId_1		15	//数字输出【C003】路数1的子设备类型第2位
...
#define A_C003_Channel_2_SlaverTypeId_1		22	//数字输出【C003】路数2的子设备类型第2位
...
#define A_C003_Channel_3_SlaverTypeId_1		29	//数字输出【C003】路数3的子设备类型第2位
...
#define A_C003_Channel_4_SlaverTypeId_1		36	//数字输出【C003】路数4的子设备类型第2位
